...
public class RunCode {
	...
	public static void main(String[] args) throws IOException{
		...
		/* future idea?:
		String firstDay = WeatherForecast.getThreeDayForecast(1);
		String secondDay = WeatherForecast.getThreeDayForecast(2);
		String thirdDay = WeatherForecast.getThreeDayForecast(3);
		*/
	}
}
