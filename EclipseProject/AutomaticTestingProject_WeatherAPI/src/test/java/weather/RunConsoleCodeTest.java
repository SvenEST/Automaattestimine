...
public class RunConsoleCodeTest {
	...
	public static void main(String[] args) throws IOException{
		...
		weatherService.updateWeather("Tallinn", 1);
		...
		weatherService.updateWeather("Tallinn", 2);
		...
		weatherService.updateWeather("Tallinn", 3);
		...
		weatherService3.updateWeather(weatherService3.getCityName(), 1);
		...
		weatherService3.updateWeather(weatherService3.getCityName(), 2);
		...
		weatherService3.updateWeather(weatherService3.getCityName(), 3);
